...
<div>
  <v-card class="py-5 px-8 flex-col" :rounded="false" flat>
    <v-card-title class="text-center text-gray-900 text-2xl font-bold">ورود به حساب کاربری</v-card-title>
    <v-card-subtitle class="text-center text-gray-600 text-lg font-semibold pb-8" >
    ...
    <v-form class="mt-4" fast-fail @submit.prevent="loginFormLogInHandler">
      ...
      <nuxt-link to="/sign-up" class="pr-3 text-right font-semibold underline text-primary" >همین الان ثبت‌نام کنید</nuxt-link>
      </div>
    </v-form>
  </v-card>
</div>
